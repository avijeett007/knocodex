...
"""
    ...
    async def get_task_events(self, limit: int = 100) -> List[TaskEvent]:
        """Get recent task events for SSE streaming"""
        try:
    ...
    async def get_log_entries(self, level: str = "INFO", limit: int = 100) -> List[LogEntry]:
