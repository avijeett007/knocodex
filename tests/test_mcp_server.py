...
class TestMCPServer(unittest.TestCase):
    ...
    @patch('knocodex.api.metrics.get_workflow_engine')
    def test_metrics_endpoint(self, mock_get_workflow_engine):
        ...
        mock_workflow.get_system_metrics.return_value = MetricsResponse(
            total_tasks=100,
            active_tasks=15,
            completed_tasks=85,
            failed_tasks=5,
    ...
    @patch('knocodex.api.metrics.get_queue_manager')
    def test_queue_metrics_endpoint(self, mock_get_queue_manager):
